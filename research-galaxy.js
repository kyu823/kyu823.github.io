...
(function () {
  ...
  const themes = [
    ...
    },
    {
      ...
      papers: [
        { id: 'sycophancy', title: 'Feeling Right vs. Being Right: AI Sycophancy in Value-Laden Deliberation', short: 'AI Sycophancy', venue: 'ACL 2026', authors: 'Jeongwoo Ryu, Soomin Kim, Jinsu Eun, Kyusik Kim, Changhoon Oh, Bongwon Suh', abstract: 'How sycophantic AI behavior undermines genuine moral reasoning — when AI agrees too readily, deliberation quality collapses.', link: 'https://aclanthology.org/2026.acl-long.2046/' },
